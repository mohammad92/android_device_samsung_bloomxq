...
# Kernel
TARGET_PREBUILT_KERNEL := device/samsung/bloomxq/prebuilt/Image.gz
TARGET_PREBUILT_DTB := device/samsung/bloomxq/prebuilt/dtb
BOARD_PREBUILT_DTBOIMAGE := device/samsung/bloomxq/prebuilt/recovery_dtbo
...
BOARD_MKBOOTIMG_ARGS += --header_version $(BOARD_BOOT_HEADER_VERSION) --pagesize $(BOARD_KERNEL_PAGESIZE) --board "SRPTC18A003"
BOARD_MKBOOTIMG_ARGS += --dtb $(TARGET_PREBUILT_DTB) --dtb_offset $(BOARD_DTB_OFFSET)
BOARD_CUSTOM_BOOTIMG_MK := device/samsung/bloomxq/bootimg.mk
...
# Dynamic Partitions
BOARD_SUPER_PARTITION_SIZE := 10764681216
BOARD_SUPER_PARTITION_GROUPS := samsung_dynamic_partitions
BOARD_SAMSUNG_DYNAMIC_PARTITIONS_SIZE := 10760486912
